...
class AllNeuralNetworks:
    ...
    def get_augmentation_mode(name):
        if name == AllNeuralNetworks.networks_names[3] or \
                name == AllNeuralNetworks.networks_names[7] or \
                name == AllNeuralNetworks.networks_names[9]:
    ...
    def get_network_model(name):
        if name == AllNeuralNetworks.networks_names[0] or name == AllNeuralNetworks.networks_names[3]:
            model = Sequential()
        ...
        if name == AllNeuralNetworks.networks_names[6] or name == AllNeuralNetworks.networks_names[7]:
            model = Sequential()
            model.add(Conv2D(32, (3, 3), activation='relu', kernel_initializer='he_uniform', padding='same',
                             input_shape=(32, 32, 3)))
            model.add(Conv2D(32, (3, 3), activation='relu', kernel_initializer='he_uniform', padding='same'))
        ...
        if name == AllNeuralNetworks.networks_names[8] or name == AllNeuralNetworks.networks_names[9]:
            model = Sequential()
            model.add(Conv2D(32, (3, 3), activation='relu', kernel_initializer='he_uniform', padding='same',
                             input_shape=(32, 32, 3)))
            model.add(Conv2D(32, (3, 3), activation='relu', kernel_initializer='he_uniform', padding='same'))
